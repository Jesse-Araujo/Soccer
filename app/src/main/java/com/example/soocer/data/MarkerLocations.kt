...
class MarkerLocations(val title: String, val latLng: LatLng, val type: Type,val capacity:Int,val city: String) {
    ...
    companion object {
        ...
        fun getClubStadium(club : String) : MarkerLocations {
            ...
            return when {
                c.contains("benfica") ->  MarkerLocations("Estádio da Luz", LatLng(38.752663, -9.184720), Type.STADIUM,65000,"Lisboa")
                c.contains("braga") -> MarkerLocations("Estádio Municipal de Braga", LatLng(41.562544, -8.429873), Type.STADIUM,30000,"Braga")
                c.contains("sporting") -> MarkerLocations("Estádio José Alvalade", LatLng(38.761158, -9.160905), Type.STADIUM,50000,"Lisboa")
                else -> MarkerLocations("Estádio do Dragão", LatLng(41.161745739580674, -8.583816308722257), Type.STADIUM,50000,"Porto")
            }
        }
    }
}
